...
const testimonials = [
  {
    ...
    content:
      "Vaulta's voice banking is incredible! I called to report my stolen card at 2 AM and had it blocked in seconds. The voice recognition knew it was me instantly. No more waiting on hold or pressing endless buttons!",
    categories: [1, 3, 5],
  },
  {
    ...
    content:
      "I check my account balance while driving every day with Vaulta. Just say the word and I get instant answers. It's like having a personal banker available 24/7. Game changer for busy professionals!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Freelancer",
    content:
      "The biometric voice verification is so smooth. No more remembering complex passwords or carrying my phone everywhere. I just speak naturally and Vaulta handles everything securely. Absolutely love it!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Consultant",
    content:
      "I was skeptical about voice banking at first, but Vaulta won me over. Transferring money, paying bills, checking transactions - all hands-free while I'm cooking or working. The future of banking is here!",
    categories: [1, 4],
  },
  {
    ...
    company: "Tech Lead",
    content:
      "As someone who values security, I'm impressed by Vaulta's voice biometrics. It's actually more secure than traditional methods and so much faster. No more fumbling with my phone to log in!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Investor",
    content:
      "Vaulta saved me when I couldn't access my app abroad. One quick voice call and I had my account details and made an urgent transfer. The AI understood my request perfectly. Incredibly reliable service!",
    categories: [1, 3],
  },
  {
    ...
    company: "Designer",
    content:
      "The natural conversation flow is amazing. I don't have to memorize commands or speak in a robot voice. Vaulta understands me like a real person would. Banking has never been this easy!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Retired",
    content:
      "I'm not very tech-savvy, but Vaulta makes banking simple. I just call and talk normally about what I need. No confusing menus or apps. Finally, technology that works for everyone!",
    categories: [1, 4],
  },
  {
    ...
    company: "Manager",
    content:
      "Multitasking is effortless with Vaulta. I manage my finances while commuting, exercising, or taking care of my kids. Voice banking fits perfectly into my busy lifestyle. Couldn't imagine going back!",
    categories: [1, 2],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="py-12 md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          <h2 className="animate-gradient bg-gradient-to-r from-gray-200 via-indigo-200 to-gray-200 bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
            Trusted by thousands
          </h2>
          <p className="text-lg text-indigo-200/65">
            See how Vaulta is transforming banking with secure, instant voice interactions.
          </p>
        </div>
...
export function Testimonial({
  ...
  return (
    <article
      className={`relative rounded-2xl bg-gradient-to-br from-gray-900/50 via-gray-800/25 to-gray-900/50 p-5 backdrop-blur-xs transition-opacity before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-gray-800),var(--color-gray-700),var(--color-gray-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${!testimonial.categories.includes(category) ? "opacity-30" : ""}`}
    >
